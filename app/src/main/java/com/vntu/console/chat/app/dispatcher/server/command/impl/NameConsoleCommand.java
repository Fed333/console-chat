...
public class NameConsoleCommand implements ConsoleCommand {
    ...
    public void process(ChatUserRequest request) {
        ...
        serverOutMessagePrinter.printlnPromptMessage(buildUpdateChatUserCommandMessage(chatUser), chatUserWriter);
        chatUserWriter.flush();
    }

    private String buildUpdateChatUserCommandMessage(ChatUser chatUser) {
